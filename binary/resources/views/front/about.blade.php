...
<html lang="en">
<head>
	<title>About Us | Repute - Responsive Multipurpose Bootstrap Theme</title>
...
<body>
	...
	<div class="wrapper">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="featured-video">
								<iframe src="http://player.vimeo.com/video/151699967"></iframe>
							</div>
						</div>
					</div>
					<br>
					...
					<div class="section-content">
						<div class="col-md-5">
							<div class="team-member media">
								<img src="{{URL::asset('front/img/team/person1.png')}}" class="media-object img-circle pull-left" alt="" />
						...
						<div class="col-md-5 col-md-offset-2">
							<div class="team-member media">
								<img src="{{URL::asset('front/img/team/person2.png')}}" class="media-object img-circle pull-left" alt="" />
								<div class="media-body">
						...
						<div class="col-md-5">
							<div class="team-member media">
								<img src="{{URL::asset('front/img/team/person3.png')}}" class="media-object img-circle pull-left" alt="" />
								<div class="media-body">
						...
						<div class="col-md-5 col-md-offset-2">
							<div class="team-member media">
								<img src="{{URL::asset('front/img/team/person4.png')}}" class="media-object img-circle pull-left" alt="" />
								<div class="media-body">
				...
				<section class="clients no-margin">
					<div class="container">
						...
						<ul class="list-inline list-client-logo">
							<li>
								<a href="#"><img src="{{URL::asset('front/img/clients/logo1.png')}}" alt="logo" /></a>
							</li>
							<li>
								<a href="#"><img src="{{URL::asset('front/img/clients/logo2.png')}}" alt="logo" /></a>
							</li>
							<li>
								<a href="#"><img src="{{URL::asset('front/img/clients/logo3.png')}}" alt="logo" /></a>
							</li>
							<li>
								<a href="#"><img src="{{URL::asset('front/img/clients/logo4.png')}}" alt="logo" /></a>
							</li>
							<li>
								<a href="#"><img src="{{URL::asset('front/img/clients/logo5.png')}}" alt="logo" /></a>
							</li>
						</ul>
					</div>
				</section>
		...
		<script src="{{URL::asset('front/js/plugins/fitvids/jquery.fitvids.js')}}"></script>
</body>
</html>

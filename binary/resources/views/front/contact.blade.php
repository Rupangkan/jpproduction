...
<!-- Mirrored from demo.thedevelovers.com/business/repute-v1.3/page-contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Jul 2018 08:09:29 GMT -->
<head>
	<title>Contact Us | Repute - Responsive Multipurpose Bootstrap Theme</title>
...
<body>
	...
	<div class="wrapper">
		...
		<script src="{{URL::asset('front/js/plugins/google-map/google-map.js')}}"></script>
</body>
</html>

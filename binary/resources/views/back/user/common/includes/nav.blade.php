<header>
    <nav class="navbar navbar-default navbar-static-top no-margin" role="navigation">
        <div class="navbar-brand-group">
            ...
            <a class="navbar-brand hidden-xxs" href="{{route('member.dashboard')}}">
        ...
        <ul class="nav navbar-nav navbar-nav-expanded pull-right margin-md-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right-xs">
                    <li class="arrow"></li>
                    <li><a href="{{route('member.profile', Sentinel::getUser()->username)}}">Profile</a></li>
                    <li><a href="{{route('change.user.password')}}">Change Password</a></li>
                    <li class="divider"></li>

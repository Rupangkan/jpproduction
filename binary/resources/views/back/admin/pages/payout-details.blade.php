...
<div class="page-content">
    ...
    <div class="page-heading page-heading-md">
        <h2>{{User::byUsername($payouts[0]->member_code)->full_name}} <span class="text-warning"><strong>PAYOUT DETAILS</strong></span></h2>
                    ...
                    <table id="table-basic" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><a href="/admin/receipt/{{$payout->id}}" class="btn-md btn btn-default">Print</a></td>
                            </tr>
                            <?php $i++; ?>
                            @endforeach
                        </tbody>
